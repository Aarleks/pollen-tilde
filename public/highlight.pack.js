...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
contains:[l,e.SHEBANG(),s,b,g,o,v,m,c]}}})());hljs.registerLanguage("javascript",(()=>{"use strict"
...
begin:"^[_a-z][\\w']*"}),n,{begin:"->|<-"}]}}})());hljs.registerLanguage("apache",(()=>{"use strict";return e=>{const n={
...
className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}})());hljs.registerLanguage("vim",(()=>{"use strict";return e=>({name:"Vim Script",
keywords:{$pattern:/[!#@\w]+/,
...
name:"TypeScript",aliases:["ts"]}),b}})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
