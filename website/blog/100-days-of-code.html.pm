...
Recently I stubmled across the ◊link["http://www.100daysofcode.com/"]{100 Days of Code} challenge. Having done my own ◊xref["/running-economy-experiment-results-follow-up.html"]{running version} over the summer I could see the value right away. Essentially, you commit to spending 1hr a day writing code, and as a result coding choices (syntax, function names, etc.) should become more second nature. But what makes the challenge for me is that it's turned into a bit of a social movement. Two of the three rules for the challenge are about sharing the experience with others by tweeting about it and by reaching out to others doing the challenge. Being a fan of socially-connected learning, this sounds pretty cool, to me.

The projects I have in mind for my 100 days are:

◊ol{
◊li{A function to take ◊link["http://www.abs.gov.au/ausstats/abs@.nsf/0/6BB427AB9696C225CA2574180004463E"]{FOR Code} data from grant applications, intitutional metadata appended to publications, etc. and make network graphs to connect them across similar instances. For example, a network of FOR codes for articles published by Western Sydney University staff in 2017.}
◊li{A function to email a list of people with a combination of unique and identical attachments. `Mail Merge` in Outlook can't do this - it can only do the same attachments for everyone. I've already got an ugly, hacky version of this, but a) it's not a function, just some script at the moment, and b) why not?}
◊li{General statistical thinking - I'll work through Roger Peng's ◊link["https://bookdown.org/rdpeng/exdata/"]{Exploratory Data Analysis} and Hadley Wickham's ◊link["http://r4ds.had.co.nz/"]{R for Data Science} books.}
◊li{I also want to skill up in Git and Shell, so I'll be looking into some courses for those.}
}
